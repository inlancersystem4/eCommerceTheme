...
<section class="w-100 border-b container herosection">
    <div class="grid-wrapper-left">
        <div class="sticky content">
            <div class="hero-row1">
                <h1 class="title">Kyiv LuxeBouquets</h1>
                <p class="subtitle">Discover Uniquely Crafted Bouquets and Gifts for Any Occasion: Spread Joy with
                    Our
                    <i> Online Flower
                        Delivery Service</i>
                </p>
            ...
            <div class="hero-row2">
                <div class="column1">
                    <img
                        src="https://uploads-ssl.webflow.com/6400d82951450021c2d1eb7b/64a03d676a877d080695084a_ewddewd%201.webp">
                </div>
                <div class="column2">
                    <p class="caption-small">Experience the joy of giving with our modern floral studio. Order
                        online and send fresh
                        flowers, plants and gifts today.</p>
                </div>
            </div>
        </div>
    </div>
    <div class="grid-wrapper-right">
        <div class="shop-card-category">
            <div class="card-category">
                <div class="content-card">
                    ...
                    <a href="./product-categorie.php" class="link link-icon-right">
                        <p> Shop now </p>
            ...
            <a href="./product-categorie.php" class="card-category-img">
                <img
        ...
        <div class="shop-card-category">
            <a href="./product-categorie.php" class="card-category-img">
                <img src="https://uploads-ssl.webflow.com/6400d82951450021c2d1eb7b/64a040efb275c16702e85ef0_saxs.webp">
            </a>
            <div class="card-category">
                <div class="content-card">
                    <h3 class="text-center">Dried Flowers</h3>
                    <a href="./product-categorie.php" class="link link-icon-left">
                        <p> shop now </p>
                        <img src="https://uploads-ssl.webflow.com/6400d82951450021c2d1eb7b/64a2b0c7cd074ceda248eb82_arrow-right.svg"
                            alt="">
                    </a>
...
<section class="w-100 border-b container aboutsection">
    ...
    <div class="grid-wrapper-right content">
        ...
        <h3 class="title">Kyiv LuxeBouquets</h3>
        <p class="sub-title">We are a modern local floral studio, which specializes in the design and delivery of
            unique bouquets. We have the best florists who carefully select each look, our studio cooperates
...
<section class="w-100 border-b container choose_us-section">
    ...
    <div class="grid-wrapper-right">
        <div class="content">
            <h3 class="title">Stylish bouquets by florists</h3>
            <p class="sub-title">At our floral studio, our professional florists craft the most elegant and stylish
                bouquets using only the freshest and highest quality materials available. We stay up-to-date with
                the latest floral design trends and offer unique arrangements that are sure to impress. Let us
                brighten up your day with our stunning bouquets and same-day delivery servi</p>
        </div>
        <div class="content">
            <h3 class="title">On-time delivery</h3>
            <p class="sub-title">Never miss a moment with our on-time flower delivery service. Our couriers will
                deliver your bouquet personally, without boxes, to ensure it arrives in perfect condition. Trust us
                to deliver your thoughtful gift reliably.</p>
        </div>
        <div class="content">
            <h3 class="title">Safe payment</h3>
            <p class="sub-title">You can feel secure when placing an order with us, as we use industry-standard
                security measures to protect your payment information. Your transaction will be safe and
                hassle-free, so you can shop with confidence.</p>
        </div>
        <div class="content">
            <h3 class="title">Subscription by your needs</h3>
            <p class="sub-title">With our subscription service tailored to your specific needs, you can enjoy the
                convenience of having beautiful bouquets delivered straight to your door at regular intervals. Our
                flexible service is perfect for busy individuals or those who want to ensure they always have fresh
                flowers on hand. You'll save time and money with this hassle-free solution to your floral needs.</p>
        </div>
    </div>
</section>
...
<section class="w-100 container border-b contact-section">
    ...
    <div class="grid-wrapper-right">
        <div class="relative-copy">
            <img
                src="https://uploads-ssl.webflow.com/6400d82951450021c2d1eb7b/64a03b42882782a8aa1f0e26_KYIV%20LB%202%20720.webp">
    ...
    <div class="container w-100 servicesection">
        <div class="grid-wrapper-left">
            <div class="fix-height">
                <img
                    src="https://uploads-ssl.webflow.com/6400d82951450021c2d1eb7b/6436a36c9d977d7032eb51ee_happiness-image-placeholder_lx1a04.webp">
            </div>
        </div>
        <div class="grid-wrapper-right flex-center content">
            <div class="flex-vertical-center text-center">
                <p class="overline">service</p>
                <h2>Flower Subcriptions</h2>
                <p>Experience the convenience and savings of regular flower deliveries with our flexible
                    subscription service - up to 30% more profitable than one-time purchases.</p>
...
<section class="w-100 content bg-section">
    <div class="wrapper-spacing-center">
        ...
        <p>Let our team of expert florists and designers create stunning, on-trend floral décor for your special
            day. Trust us to bring your vision to life.</p>
